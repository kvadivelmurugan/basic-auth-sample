...
INSERT INTO roles VALUES (10002, 'EVENTS_ROLE', '2021-01-05 18:00:00', '2021-01-06 18:00:00', 'A');
INSERT INTO roles VALUES (10003, 'CONTACTS_ROLE', '2021-01-05 18:00:00', '2021-01-06 18:00:00', 'A');
INSERT INTO roles VALUES (10004, 'NOTES_ROLE', '2021-01-05 18:00:00', '2021-01-06 18:00:00', 'A');
INSERT INTO roles VALUES (10005, 'EXPENSES_ROLE', '2021-01-05 18:00:00', '2021-01-06 18:00:00', 'A');

UPDATE roles set role_name='EVENTS_ROLE' WHERE role_id=10002;
UPDATE roles set role_name='CONTACTS_ROLE' WHERE role_id=10003;
UPDATE roles set role_name='NOTES_ROLE' WHERE role_id=10004;
UPDATE roles set role_name='EXPENSES_ROLE' WHERE role_id=10005;
